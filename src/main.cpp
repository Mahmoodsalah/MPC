      ...
      if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
        ...
        if (s != "") {
          ...
          if (event == "telemetry") {
            ...
            // Simulator show points connected by a Green line
            msgJson["mpc_x"] = mpc_x_vals;
            msgJson["mpc_y"] = mpc_y_vals;

            //Display the waypoints/reference line
            // add (x,y) points to list
            // Simulator show points connected by a Yellow line
            ...
            // Latency (purpose is to mimic real driving conditions)
